...
<nav class="navbar navbar-expand-lg navbar-dark menu shadow fixed-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        ...
        <button type="button" class="rounded-pill btn-rounded"><a class="btn-orcamento" href=""></a>
          +55 61 8199-2905
          <span>
  ...
  <div class="container">
    <div class="row align-items-center text-white">
      ...
      <div class="col-md-6 intros text-start">
        <h1 class="display-2">
          <span class="display-2--intro">Site em Construção</span>
  ...
  <section id="campanies" class="campanies">
    <div class="container">
      <div class="row text-center">
        <h4 class="fw-bold lead mb-3">Empresas Parceiras</h4>
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-lg-2">
          <div class="campanies__logo-box shadow-sm">
            <a href="https://www.alexandrenavarro.com.br/"><img src="<?php echo e(asset('img/campanies/campany-3.jpeg')); ?>" alt="Campany 3 logo" title="Campany 3 Logo" class="img-fluid"></a>
          </div>
        </div>
        <div class="col-md-4 col-lg-2">
          <div class="campanies__logo-box shadow-sm">
            <a href="https://www.instagram.com/ericdoourodesign.mktdigital/"><img src="<?php echo e(asset('img/campanies/campany-2.png')); ?>" alt="Campany 4 logo" title="Campany 4 Logo" class="img-fluid"></a>
          </div>
        </div>
      </div>
    </div>
...
<section id="services" class="services">
  <div class="container">
    <div class="row text-center">
      <h1 class="display-3 fw-bold">Nossos Serviços</h1>
      ...
      <div class="col-md-6 border-right">
        <div class="bg-white p-3">
          <h2 class="fw-bold text-capitalize text-center">
            Nossos Serviços Partem do Designe Inicial ao Desenvolvimento de Sites
          </h2>
        </div>
      </div>
      <div class="col-md-6">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-end">
        <div class="services__pic">
          <img src="<?php echo e(asset('img/services/service-1.png')); ?>" alt="marketing illustration" class="img-fluid">
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-start">
        <div class="services__pic">
          <img src="<?php echo e(asset('img/services/service-2.png')); ?>" alt="web development illustration" class="img-fluid">
        </div>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4">
        <div class="services__content">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-end">
        <div class="services__pic">
          <img src="<?php echo e(asset('img/services/service-3.png')); ?>" alt="cloud hosting illustration" class="img-fluid">
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            ...
            <div class="testimonials__picture">
              <img src="<?php echo e(asset('img/testimonials/client-1.jpg')); ?>" alt="client-1 picture" class="rounded-circle img-fluid">
            </div>
            <!-- client name & role  -->
          ...
          <div class="carousel-item">
            ...
            <!-- client picture  -->
            <div class="testimonials__picture">
              <img src="<?php echo e(asset('img/testimonials/client-2.jpg')); ?>" alt="client-2 picture" class="rounded-circle img-fluid">
            </div>
            <!-- client name & role  -->
            <div class="testimonials__name">
              <h3>Joy Marete</h3>
          ...
          <div class="carousel-item">
            ...
            <!-- client picture  -->
            <div class="testimonials__picture">
              <img src="<?php echo e(asset('img/testimonials/client-3.jpg')); ?>" alt="client-3 picture" class="rounded-circle img-fluid">
            </div>
            <!-- client name & role  -->
            <div class="testimonials__name">
          ...
          <div class="carousel-item">
            ...
            <!-- client picture  -->
            <div class="testimonials__picture">
              <img src="<?php echo e(asset('img/testimonials/client-4.jpg')); ?>" alt="client-4 picture" class="rounded-circle img-fluid">
            </div>
            <!-- client name & role  -->
            <div class="testimonials__name">
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6">
        <div class="portfolio-box shadow">
          <img src="<?php echo e(asset('img/portfolio/portfolio-1.jpg')); ?>" alt="portfolio 1 image" title="portfolio 1 picture" class="img-fluid">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="portfolio-box shadow">
          <img src="<?php echo e(asset('img/portfolio/portfolio-2.jpg')); ?>" alt="portfolio 2 image" title="portfolio 2 picture" class="img-fluid">
          <div class="portfolio-info">
            <div class="caption">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="portfolio-box shadow">
          <img src="<?php echo e(asset('img/portfolio/portfolio-3.jpg')); ?>" alt="portfolio 3 image" title="portfolio 3 picture" class="img-fluid">
          <div class="portfolio-info">
            <div class="caption">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="portfolio-box shadow">
          <img src="<?php echo e(asset('img/portfolio/portfolio-4.jpg')); ?>" alt="portfolio 4 image" title="portfolio 4 picture" class="img-fluid">
          <div class="portfolio-info">
            <div class="caption">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="portfolio-box shadow">
          <img src="<?php echo e(asset('img/portfolio/portfolio-5.jpg')); ?>" alt="portfolio 5 image" title="portfolio 5 picture" class="img-fluid">
          <div class="portfolio-info">
            <div class="caption">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="portfolio-box shadow">
          <img src="<?php echo e(asset('img/portfolio/portfolio-6.jpg')); ?>" alt="portfolio 6 image" title="portfolio 6 picture" class="img-fluid">
          <div class="portfolio-info">
            <div class="caption">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="portfolio-box shadow">
          <img src="<?php echo e(asset('img/portfolio/portfolio-7.jpg')); ?>" alt="portfolio 7 image" title="portfolio 7 picture" class="img-fluid">
          <div class="portfolio-info">
            <div class="caption">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="portfolio-box shadow">
          <img src="<?php echo e(asset('img/portfolio/portfolio-8.jpg')); ?>" alt="portfolio 8 image" title="portfolio 8 picture" class="img-fluid">
          <div class="portfolio-info">
            <div class="caption">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="portfolio-box shadow">
          <img src="<?php echo e(asset('img/portfolio/portfolio-9.jpg')); ?>" alt="portfolio 9 image" title="portfolio 9 picture" class="img-fluid">
          <div class="portfolio-info">
            <div class="caption">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
        ...
        <div class="contact-box__info">
          <a href="#" class="contact-box__info--title">+55 61 8199-2905</a>
          <p class="contact-box__info--subtitle">  Seg-Sex 9h-18h</p>
        </div>
      </div>  
      <!-- CONTENT FOR EMAIL  -->
      <div class="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
        ...
        <div class="contact-box__info">
          <a href="#" class="contact-box__info--title">navarroeouromkt@gmail.com</a>
    ...
    <div class="container">
      <div class="row py-4 text-center text-white">
        ...
        <div class="col-lg-7 col-md-6">
          <a href="https://www.facebook.com/Navarro-Ouro-Mkt-Digital-108349231786040"><i class="fab fa-facebook"></i></a>
          <a href="https://instagram.com/navarroeouro.mktdigital?utm_medium=copy_link"><i class="fab fa-instagram"></i></a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container mt-5">
    <div class="row text-white justify-content-center mt-3 pb-3">
      <div class="col-12 col-sm-6 col-lg-6 mx-auto">
        <h5 class="text-capitalize fw-bold">Navarro&Ouro Soluções</h5>
      ...
      <div class="row text-center text-white">
        <div class="col-12">
          <div class="footer-bottom__copyright">
            &COPY; Copyright 2022 <a href="#">Navarro&Ouro Soluções</a> | Created by <a href="" target="_blank">N&O Soluções</a><br><br>
          </div>
        </div>
      </div>
    </div>
...
<a href="#" class="shadow btn-primary rounded-circle back-to-top">
  <i class="fas fa-chevron-up"></i>
    ...
    <script src="<?php echo e(asset('vendors/js/glightbox.min.js')); ?>"></script>
    <!--
...
</html><?php /**PATH C:\Users\User\Desktop\laravel projects\siteneo\resources\views/N&O.blade.php ENDPATH**/ ?>